...
type FormValues = {
  ...
  SoporteTécnico: string[];
  RevisiónMantenimiento: string[];
  InstalarReinstalarProgramas: string[];
  CopiaSeguridad: string[];
  SolicitudEInformatico: string[];
...
export default function WizardForm() {
  const { control, handleSubmit, register, watch } = useForm<FormValues>({
    defaultValues: {
      ...
      serie: "",
      SoporteTécnico: [],
      RevisiónMantenimiento: [],
      InstalarReinstalarProgramas: [],
      CopiaSeguridad: [],
      SolicitudEInformatico: [],
      CorreoInstitucional: [],
    },
  });
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4 dark:bg-neutral-950">
    {/* "flex justify-center items-center h-screen bg-gray-100 p-4 dark:bg-neutral-950" */}
                   
      <div className= "bg-white shadow-md rounded-xl w-full max-w-3xl p-4 sm:p-6 overflow-auto max-h-[90vh] dark:bg-neutral-800">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
          <div className="flex items-center gap-3 mb-8">
            {/* <IconHeadset stroke={2} className="text-neutral-700 w-10 h-10" /> */}
            <img
              src="../../../public/img/headphone.png"
              className="w-15 h-15 dark:invert dark:brightness-100"
            ></img>

            <div className="flex flex-col">
              <span className="font-semibold text-2xl text-neutral-800 dark:text-neutral-100">
                Soporte Técnico
              </span>
          ...
          {step === 1 && (
            <div className="flex flex-col gap-4 items-center">
              <div className="flex flex-col">
                <label
                  htmlFor="inventarioequipo"
                  className="mb-2 font-medium text-neutral-800 dark:text-neutral-200"
                >
              ...
              <div className="flex flex-col">
                <label
                  htmlFor="marca"
                  className="mb-1 font-medium text-neutral-800 dark:text-neutral-200"
                >
                  Marca
                </label>
                <input
              ...
              <div className="flex flex-col">
                <label
                  htmlFor="modelo"
                  className="mb-1 font-medium text-neutral-800 0 dark:text-neutral-200"
                >
                  Modelo
                </label>
                <input
          ...
          {step === 2 && (
            <div className="grid grid-cols-3 gap-4">
              ...
              <Controller
                control={control}
                name="InstalarReinstalarProgramas"
                render={({ field }) => (
                  <MultiSelect
                    value={field.value}
                    onChange={field.onChange}
              ...
              <div className="col-span-3">
                <label
                  ...
                  className="text-sm font-medium text-gray-700 mb-1 dark:text-neutral-200"
                >
                  Observaciones
                </label>
                <textarea
                ...
                render={({ field }) => (
                  <MultiSelect
                    ...
                    options={[
                      ...
                      {
                        value: "design",
                        label: "Cliente de Correo (PC / Smartphone / Tablet)",
                      },
                    ]}
              ...
              <div className="col-span-3 flex items-center gap-2">
                <input
                  type="checkbox"
                  id="habilitarObservaciones"
                  {...register("habilitarObservaciones")}
                  className="w-4 h-4 accent-cyan-600"
                />
                <label
                  htmlFor="habilitarObservaciones"
                  className="text-sm font-bold text-gray-700 dark:text-neutral-100"
                >
                  Otros{" "}
                  <span className="font-medium dark: text-neutral-300">
                    Si ninguna de las opciones anteriores satisface los
                    requerimientos de su solicitud:
                  </span>
                </label>
              </div>
